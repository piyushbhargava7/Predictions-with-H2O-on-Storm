...
public class H2OStormStarter {
  ...
  public static class PredictionBolt extends BaseRichBolt {
    ...
    @Override public void execute(Tuple tuple) {
      ...
      storm.starter.GBMPojo p = new storm.starter.GBMPojo();
      ...
      // get the predictions
      double[] preds = new double [storm.starter.GBMPojo.NCLASSES+1];
  ...
  public static class ClassifierBolt extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
      ...
      try {
        File file = new File("/Users/piyushbhargava/github/h2o-world-2015-training/tutorials/streaming/storm/web/out"); // EDIT ME TO YOUR PATH!
