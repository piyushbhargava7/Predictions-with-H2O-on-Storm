...
public class TestH2ODataSpout extends BaseRichSpout {
  ...
  public void nextTuple() {
    Utils.sleep(1000);
    File file = new File("/Users/piyushbhargava/github/h2o-world-2015-training/tutorials/streaming/storm/live_data.csv");  // EDIT ME TO YOUR PATH!
  ...
  public void declareOutputFields(OutputFieldsDeclarer declarer) {
    LinkedList<String> fields_list = new LinkedList<String>(Arrays.asList(storm.starter.GBMPojo.NAMES));
